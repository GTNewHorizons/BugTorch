...
public abstract class MixinSlotMerchantResult {
    ...
    private boolean func_75230_a(MerchantRecipe requirements, ItemStack offeredItem1, ItemStack offeredItem2) {
        ...
        if (offeredItem1 != null && offeredItem1.getItem() == itemstack1.getItem()
                && (offeredItem1.getItemDamage() == itemstack1.getItemDamage())) {
            if (itemstack2 != null && offeredItem2 != null
                    && itemstack2.getItem() == offeredItem2.getItem()
                    && itemstack2.getItemDamage() == offeredItem2.getItemDamage()) {
