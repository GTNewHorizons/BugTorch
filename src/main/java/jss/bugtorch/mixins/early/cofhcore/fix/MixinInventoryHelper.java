...
public abstract class MixinInventoryHelper {
    ...
    /**
     * @author jss2a98aj
     * @reason Fix item dupes and inventory loss from CoFHLib by replacing this mergeItemStack with an adaption of
     *         MixinsContainer's.
     */
    @Overwrite(remap = false)
    public static boolean mergeItemStack(List<Slot> inventorySlots, ItemStack input, int start, int length,
            boolean reverse, boolean unused) {
