    ...
    private boolean func_75529_b() {
        ...
        while (true) {
            ...
            theVillage = worldObj.villageCollectionObj.findNearestVillage(
                    (int) entityplayer.posX, (int) entityplayer.posY, (int) entityplayer.posZ, 1);

            if (theVillage != null
                    && theVillage.getNumVillageDoors() >= 10
                ...
                for (int i = 0; i < 10; ++i) {
                    ...
                    flag = false;
                    Iterator iterator1 =
                            worldObj.villageCollectionObj.getVillageList().iterator();
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            if (theVillage.isInRange(i1, j1, k1)
                    && SpawnerAnimals.canCreatureTypeSpawnAtLocation(
                            EnumCreatureType.monster, this.worldObj, i1, j1, k1)) {
