        ...
        if (block instanceof IShearable) {
            ...
            if (target.isShearable(itemStack, player.worldObj, x, y, z)) {
                ...
                for (ItemStack stack : drops) {
                    float f = 0.7F;
                    // Swap to itemRand rather than making a new random instance every time shears break an IShearable
                    // block
                    ...
                    EntityItem entityitem =
                            new EntityItem(player.worldObj, (double) x + dx, (double) y + dy, (double) z + dz, stack);
