...
public class BugTorchConfig {
    ...
    // Base features
    public static boolean fixSquidsSounds;
    ...
    public static void loadBaseConfig(File configFile) {
        ...
        fixSquidsSounds = config.getBoolean(
                "fixSquidsSounds", categoryBugfixes, true, "Squids will make sounds (requires TX Loader)");
    ...
    public static void loadModdedConfig(File configFile) {
        ...
        fixPamsTemperatePlantsBlockSounds = config.getBoolean(
                ...
                categoryBugfixes,
                true,
                "Assigns the correct sound type to blocks from Pam's Temperate Plants.");
        fixWitcheryBlockSounds = config.getBoolean(
                "fixWitcheryBlockSounds",
                categoryBugfixes,
                true,
                "Assigns the correct sound type to blocks from Witchery.");
        ...
        reverseCraftThaumcraftSlabs = config.getBoolean(
                "reverseCraftThaumcraftSlabs", categoryTweaks, true, "Craft Thaumcraft slabs back into blocks.");
    ...
    public static void loadBaseMixinConfig(File configFile) {
        ...
        deadBushesDropSticks = config.getBoolean(
                "deadBushesDropSticks", categoryBackport, true, "Dead Bushes drop 0-2 Sticks.\nFrom MC 1.9");
        ...
        throwEnderPearlsInCrativeMode = config.getBoolean(
                "throwEnderPearlsInCrativeMode",
                categoryBackport,
                true,
        ...
        fixShearedBlocksDropExtraItems = config.getBoolean(
                "fixShearedBlocksDropExtraItems",
                categoryBugfixes,
                true,
        ...
        fasterSnowBlockTicks = config.getBoolean(
                "fasterSnowBlockTicks", categoryPerformance, true, "Non-layered snow block ticking is faster.");
        ...
        // Tweaks
        farmlandImprovements = config.getBoolean(
                "farmlandImprovements",
                categoryTweaks,
                false,
        ...
        placeTorchesOnAnyFence =
                config.getBoolean("placeTorchesOnAnyFence", categoryTweaks, true, "Place torches on almost any fence.");
        placeTorchesOnAnyWall =
                config.getBoolean("placeTorchesOnAnyWall", categoryTweaks, true, "Place torches on almost any wall.");
        potionParticlesAreClearForClientPlayer = clientSide
                && config.getBoolean(
        ...
        removeEntityDuplicateExtendedPropertiesIdentifierSpam = config.getBoolean(
                ...
                categoryTweaks,
                true,
                "Removes \"An attempt was made to register exended properties using an existing key\" log spam caused by some mods.");

        lanPortToUseForOverride = config.getInt(
                "lanPortToUseForOverride", categoryTweaks, 25565, 1024, 49151, "Port to use for lanPortOverride.");
    ...
    public static void loadModdedMixinConfig(File configFile) {
        ...
        // Mod file names
        ganysSurfaceJarName = config.getString(
                "ganysSurfaceJarName",
                categoryModNames,
                "Ganys+Surface",
        ...
        fixWitcheryLeavesShearDupeAndOptifineRendering = config.getBoolean(
                "fixWitcheryLeavesShearDupeAndOptifineRendering",
                categoryBugfixes,
                true,
                "Makes Witchery Leaves respect Optifine render settings and partially fixes a Forge shearing bug.");
