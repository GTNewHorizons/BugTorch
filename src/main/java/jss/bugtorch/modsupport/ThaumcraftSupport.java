    ...
    public static void enableSupport() {
        ...
        if (BugTorchConfig.registerThaumcraftLeavesToTheOreDictionary) {
            OreDictionary.registerOre(
                    "treeLeaves", new ItemStack(ConfigBlocks.blockMagicalLeaves, 1, OreDictionary.WILDCARD_VALUE));
        }
        ...
        if (BugTorchConfig.craftThaumcraftAncientStoneSlabsAndStairs) {
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    new ItemStack(ConfigBlocks.blockSlabStone, 6, 1), "XXX", Character.valueOf('X'), ancientStone));
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    new ItemStack(ConfigBlocks.blockStairsEldritch, 4),
                    "X  ",
                    "XX ",
                    "XXX",
                    Character.valueOf('X'),
        ...
        if (BugTorchConfig.reverseCraftThaumcraftSlabs) {
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    ...
                    "X",
                    Character.valueOf('X'),
                    new ItemStack(ConfigBlocks.blockSlabWood, 1, 0)));
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 7),
                    "X",
                    "X",
                    Character.valueOf('X'),
                    new ItemStack(ConfigBlocks.blockSlabWood, 1, 1)));
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 7),
                    "X",
                    "X",
                    Character.valueOf('X'),
                    new ItemStack(ConfigBlocks.blockSlabStone, 1, 0)));
            if (BugTorchConfig.craftThaumcraftAncientStoneSlabsAndStairs) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        ancientStone,
                        "X",
                        "X",
                        Character.valueOf('X'),
                        new ItemStack(ConfigBlocks.blockSlabStone, 1, 1)));
            }
        }
    }
}
