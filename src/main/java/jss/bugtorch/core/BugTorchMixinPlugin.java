...
public class BugTorchMixinPlugin implements IMixinConfigPlugin {
    ...
    public List<String> getMixins() {
        ...
        if (!(Boolean) Launch.blackboard.get("fml.deobfuscatedEnvironment")) {
            if (BugTorchConfig.ganysSurfaceJarName.equals("d")
                    || !loadJar(BugTorchConfig.ganysSurfaceJarName, "Gany's Surface")) {
                BugTorchConfig.fixGanysSurfaceOpenTrapdoorBackTexture = false;
            }
            if (BugTorchConfig.thaumcraftJarName.equals("d")
                    || !loadJar(BugTorchConfig.thaumcraftJarName, "Thaumcraft")) {
            ...
            if (BugTorchConfig.aetherIIJarName.equals("d")
                    || !loadJar(BugTorchConfig.aetherIIJarName, "The Aether II")) {
        ...
        if (BugTorchConfig.replaceRandomInWorld) {
            BugTorchCore.logger.info(
                    "World.class will use a faster Random implementation, this impacts world generation slightly.");
