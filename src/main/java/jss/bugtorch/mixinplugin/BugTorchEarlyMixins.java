...
public class BugTorchEarlyMixins implements IFMLLoadingPlugin, IEarlyMixinLoader {
    ...
    public List<String> getMixins(Set<String> loadedCoreMods) {
        ...
        if (BugTorchConfig.scaledDrowningDamageMaxHealthFlat > 0f
        ...
        if (BugTorchConfig.scaledStarvationDamageMaxHealthFlat > 0f
                || BugTorchConfig.scaledStarvationDamageMaxHealthMult > 0f) {
            mixins.add("minecraft.tweaks.MixinFoodStats");
        }
        if (BugTorchConfig.scaledSuffocationDamageMaxHealthFlat > 0f
        ...
        if (BugTorchConfig.scaledPoisonDamageMaxHealthFlat > 0f
                || BugTorchConfig.scaledPoisonDamageMaxHealthMult > 0f) {
            mixins.add("minecraft.tweaks.potion.MixinsPotionPoison");
        }
        if (BugTorchConfig.scaledWitherDamageMaxHealthFlat > 0f
